...
export default function EnglishNewLandingPage() {
    ...
    <div className={`min-h-screen text-[#3A405A] ${notoSansJP.className} overflow-x-hidden`}>
      ...
      <nav className="bg-white/80 backdrop-blur-md border-b border-cyan-100 sticky top-0 z-50">
        <div className="max-w-[1200px] mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/english/signup"
              className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-6 py-2 rounded-full font-bold hover:shadow-lg hover:scale-105 transition-all"
            >
              無料で始める
            </Link>
          </div>
      ...
      <header className="relative min-h-[95vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto px-4 text-center text-white">
          {/* キャンペーンバッジ */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-5 py-2.5 rounded-full text-sm font-bold mb-6 shadow-lg animate-pulse">
            <Gift className="w-4 h-4" />
            先着100名 永久54%OFF キャンペーン
            <Gift className="w-4 h-4" />
          </div>
          ...
          <p className="text-xl md:text-2xl mb-8 leading-relaxed opacity-90 font-medium">
            AIが毎朝、日本のニュースを英語でお届け<br className="hidden md:block" />
            自然な音声で、ビジネス英語が身につく
          </p>

          {/* 価格比較 - 目立つデザイン */}
          <div className="bg-white/15 backdrop-blur-md rounded-2xl p-6 mb-8 border border-white/30 max-w-[500px] mx-auto">
            <div className="flex items-center justify-center gap-4 md:gap-8">
              <div className="text-center">
                <p className="text-sm opacity-70 mb-1">通常価格</p>
                <p className="text-3xl font-bold text-white/50 line-through">¥980</p>
              </div>
              <div className="text-3xl">→</div>
              <div className="text-center">
                <p className="text-sm text-yellow-300 font-bold mb-1">キャンペーン価格</p>
                <p className="text-5xl font-black text-yellow-300">¥450</p>
          ...
          {remaining !== null && (
            <div className="mb-8">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                ...
                <span className="font-bold">残り <span className="text-yellow-300 text-xl">{remaining}</span> 名様</span>
              </div>
            </div>
          )}
      ...
      {/* Why Now Section - english-campaign から */}
      <section className="py-20 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-[900px] mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-yellow-100 text-yellow-700 px-4 py-2 rounded-full text-sm font-bold mb-4">
            ...
            <h2 className="text-4xl md:text-5xl font-black mb-4">
              なぜ<span className="text-yellow-600">今</span>入会すべきなのか？
            </h2>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl p-8 border border-yellow-200 text-center shadow-lg">
              <div className="text-6xl font-black text-yellow-500 mb-4">54%</div>
              <p className="font-bold text-xl mb-2 text-[#3A405A]">永久割引</p>
              <p className="opacity-70 text-[#3A405A]">一度入会すれば、解約するまでずっと450円/月のまま</p>
            </div>
            <div className="bg-gradient-to-br from-cyan-50 to-teal-50 rounded-3xl p-8 border border-cyan-200 text-center shadow-lg">
              <div className="text-6xl font-black text-cyan-500 mb-4">100</div>
              <p className="font-bold text-xl mb-2 text-[#3A405A]">名様限定</p>
              <p className="opacity-70 text-[#3A405A]">先着100名に達した時点でキャンペーン終了</p>
            </div>
            <div className="bg-gradient-to-br from-teal-50 to-emerald-50 rounded-3xl p-8 border border-teal-200 text-center shadow-lg">
              <div className="text-6xl font-black text-teal-500 mb-4">∞</div>
              <p className="font-bold text-xl mb-2 text-[#3A405A]">期間無制限</p>
              <p className="opacity-70 text-[#3A405A]">後から値上げされることはありません</p>
            </div>
          </div>

          <div className="mt-12 text-center">
            <div className="inline-block bg-white rounded-2xl p-6 border border-gray-200 shadow-lg">
              <p className="text-lg text-[#3A405A]">
                <span className="text-gray-500 font-bold">通常価格980円/月</span>で入会すると、
                <span className="text-red-500 font-bold">年間11,760円</span>
              </p>
              <p className="text-2xl font-black mt-2 text-[#3A405A]">
                キャンペーン価格なら<span className="text-yellow-600">年間5,400円</span>
                <span className="text-green-600 ml-2">（6,360円お得！）</span>
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Comparison Table - english-campaign から */}
      <section className="py-20 px-4 bg-white">
        <div className="max-w-[800px] mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-black mb-4">
              他サービスと<span className="text-cyan-600">比較</span>
            </h2>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50">
                  <th className="p-4 text-left text-[#3A405A] font-bold">サービス</th>
                  <th className="p-4 text-center text-[#3A405A] font-bold">月額</th>
                  <th className="p-4 text-center text-[#3A405A] font-bold">日本語対応</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-t border-gray-100">
                  <td className="p-4 text-[#3A405A]">英語ニュースアプリA</td>
                  <td className="p-4 text-center text-[#3A405A]">¥1,500</td>
                  <td className="p-4 text-center text-gray-400">×</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="p-4 text-[#3A405A]">リスニング教材B</td>
                  <td className="p-4 text-center text-[#3A405A]">¥2,000</td>
                  <td className="p-4 text-center text-green-500">○</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="p-4 text-[#3A405A]">オンライン英会話C</td>
                  <td className="p-4 text-center text-[#3A405A]">¥6,000〜</td>
                  <td className="p-4 text-center text-green-500">○</td>
                </tr>
                <tr className="border-t-2 border-cyan-400 bg-gradient-to-r from-cyan-50 to-teal-50">
                  <td className="p-4 font-bold text-cyan-600">Roopy English</td>
                  <td className="p-4 text-center">
                    <span className="text-2xl font-black text-cyan-600">¥450</span>
                  </td>
                  <td className="p-4 text-center text-cyan-600 font-bold">◎</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl shadow-lg p-6 border border-yellow-100">
              ...
              <p className="text-lg mb-4 text-[#3A405A] font-medium">
                「毎朝の通勤電車で聞いてます。日本のニュースだから内容がわかりやすく、続けられてます！450円でこの内容は破格です。」
              </p>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="space-y-4">
            {[
              { q: '料金はいくらですか？', a: '先着100名様限定で月額450円（通常980円）でご利用いただけます。一度入会すれば、解約するまでずっとこの価格でお使いいただけます。' },
              ...
              { q: 'いつでも解約できますか？', a: 'はい、いつでもご自身で解約可能です。解約手続きは管理画面から簡単に行えます。' },
            ].map((faq, i) => (
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[700px] mx-auto text-center text-white">
          <div className="mb-6">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-6 py-3 rounded-full text-lg font-bold shadow-lg">
          ...
          {/* 価格表示 */}
          <div className="bg-white/15 backdrop-blur-md rounded-2xl p-6 mb-8 border border-white/30 max-w-[400px] mx-auto">
            <div className="flex items-center justify-center gap-4">
              <div className="text-center">
                <p className="text-white/50 line-through text-xl">¥980</p>
              </div>
              <div className="text-2xl">→</div>
              <div className="text-center">
                <p className="text-5xl font-black text-yellow-300">¥450</p>
                <p className="text-yellow-300 text-sm font-bold">/月（永久）</p>
              </div>
            </div>
          </div>

          {remaining !== null && (
            <p className="text-xl font-bold mb-8 text-yellow-300">
              残り {remaining} 名様で終了
            </p>
          )}
