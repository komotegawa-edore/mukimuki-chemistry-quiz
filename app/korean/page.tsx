...
const situations: { icon: LucideIcon; label: string }[] = [
  { icon: Plane, label: '空港' },
  { icon: Train, label: '電車' },
  { icon: Coffee, label: 'カフェ' },
  { icon: Users, label: '友達との会話' },
  { icon: CloudSun, label: '天気予報' },
  { icon: ShoppingBag, label: 'お店' },
  { icon: Phone, label: '電話予約' },
  { icon: MapPin, label: '道案内' },
  { icon: GraduationCap, label: '学校' },
      ...
      <section className="py-16 px-4">
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="space-y-6">
            ...
            <Link
              href="/korean/listening"
              className="block bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-pink-100 hover:shadow-xl transition-shadow"
            >
            ...
            <Link
              href="/korean/quiz"
              className="block bg-white rounded-2xl shadow-md p-6 md:p-8 border border-gray-100 hover:shadow-lg transition-shadow"
            >
              <div className="flex items-start gap-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            {situations.map((item) => {
              ...
              return (
                ...
                >
                  <Icon className="w-8 h-8 mx-auto mb-2 text-pink-400" />
