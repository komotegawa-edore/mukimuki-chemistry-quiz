...
import { JukuSection, SectionType, sectionTypeLabels } from '../../juku/types'

interface Props {
  sections: JukuSection[]
  selectedSection: JukuSection | null
  onSelect: (section: JukuSection) => void
  onReorder: (sections: JukuSection[]) => void
  onAdd: (type: SectionType) => void
  onDelete: (sectionId: string) => void
  onToggleVisibility: (section: JukuSection) => void
}
  ...
  return (
    ...
    >
      ...
      <span className={`flex-1 text-sm font-medium ${!section.is_visible ? 'text-gray-400' : 'text-gray-700'}`}>
        {sectionTypeLabels[section.type as SectionType]}
      </span>
