...
function LoginForm() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // English Newsページへリダイレクト
      window.location.href = '/english/news'
    } catch (err) {
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="mb-8 text-center">
            ...
            <p className="text-[#3A405A] text-sm">毎朝届く英語ニュース</p>
          </div>
          ...
          <div className="mt-4 text-center text-sm">
            ...
            <Link href="/english/signup" className="text-cyan-500 hover:text-cyan-600 font-semibold ml-2">
              新規登録
            </Link>
          </div>
